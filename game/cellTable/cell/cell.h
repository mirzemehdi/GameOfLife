...
placed in some area with size given by the user. The cell has the row number, column number
(in order to see the location in the area) and the argument isAlive in order to see 
the Status of the cell (if the cell is dead or alive). */
